...
// This implementation was shamefully taken from Flambe, which uses an MIT
// license: https://github.com/aduros/flambe/blob/master/LICENSE.txt

/** Receives and returns a number between [0,1]. */
typedef EaseFunction = Float -> Float;

/**
 * Easing functions that can be used to animate values.
 * For a cheat sheet, see <http://easings.net>.
 */
class Ease {

    /** Easing constants */
    private static inline var PI = 3.141592653589793;
    private static inline var PIhalf: Float = PI / 2;
    private static inline var PI2: Float = PI * 2;
